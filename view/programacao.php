...
<head>
    <meta charset="utf-8">
    <title>PROGRAMAÇÃO - TECHNOMONTE 2K19</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark bg-blue">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link ativo" href="programacao.php">Programação</a>
                </li>
                <li class="nav-item dropdown">
    ...
    <div class="container">
        ...
        <table class="table">
            <thead>
                <tr bgcolor="#AAD931">
                    <td>
                        <th scope="col">01/10/2019 - Terça-feira</th>
                        <td></td>
                        <td></td>
                    </td>    
                </tr>
            ...
            <tbody>
                <tr>
                    <th width="20%" scope="row">19h00 - 19h30</th>
                    <td width="50%">Credenciamento</td>
                    <td width="30%">Anfiteatro UNIFUCAMP</td>
                </tr>
                <tr>
                    <th scope="row">19h30 - 20h00</th>
                    <td>Abertura do evento</td>
                    <td>Anfiteatro UNIFUCAMP</td>
                </tr>
                <tr>
                    <th scope="row">20h15 - 21h45</th>
                    <td>Palestra: "A perícia computacional na Polícia Federal"<br>
                    <i>Ministrante: Gilson Marques da Silva (Perito Criminal Federal e Professor)</i></td>
                    <td>Anfiteatro UNIFUCAMP</td>
                </tr>
            </tbody>
            <thead>
                <tr bgcolor="#AAD931">
                    <td>
                        <th scope="col">02/10/2019 - Quarta-feira</th>
                        <td></td>
                        <td></td>
                    </td>
                </tr>
            ...
            <tbody>
                <tr>
                    ...
                    <td width="50%">Minicurso: Introdução a Aprendizado de Máquina: modelos de classificação<br>
                    <i>Ministrantes: Pâmela Rezende (UFMG) e Joicymara Xavier (UFVJM)</i></td>
                ...
                <tr>
                    <th width="20%"scope="row">09h00 - 12h00<br>13h30 - 16h30</th>
                    <td width="50%">Minicurso: Conhecendo React<br>
					<i>Ministrante: Leandro Queiroz de Oliveira (Zup IT)</i></td>
                    <td width="30%">Laboratórios BSI (Bloco 1B, 1º andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>
                <tr>
                    <th width="20%"scope="row">09h00 - 12h00<br>13h30 - 16h30</th>
                    <td width="50%">Minicurso: Realidade Realidade Aumentada Aplicada à Otimização de Espaços Residenciais<br>
					<i>Ministrante: Camilo de Lellis Barreto Junior (UFU)</i></td>
                    <td width="30%">Laboratórios BSI (Bloco 1B, 1º andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>
                <tr>
                    <th width="20%" scope="row">19h00 - 20h30</th>
                    <td width="50%">Mostra de Trabalhos de Iniciação Científica e Conclusão de Curso</td>
                    <td width="30%">Anfiteatro UNIFUCAMP</td>
                </tr>
                <tr>
            ...
            <thead>
                <tr bgcolor="#AAD931">
                    <td>
                        <th scope="col">03/10/2019 - Quinta-feira</th>
                        <td></td>
                        <td></td>
                    </td>
                </tr>
            ...
            <tbody>
                <tr>
                    <th width="20%" scope="row">07h15 - 08h15<br>08h20 - 10h20</th>
                    <td width="50%">Aquecimento Maratona de Programação - Jovens Programadores<br>Maratona de Programação - Jovens Programadores</td>
                    <td width="30%">Laboratórios BSI-UFU (Bloco 1B, 1º
                        andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>
                <tr>
                    <th width="20%" scope="row">08h00 - 08h45<br>09h00 - 12h00</th>
                    <td width="50%">Aquecimento Maratona de Programação - Universitários<br>Maratona de Programação - Universitários</td>
                    <td width="30%">Laboratórios BSI-UFU (Bloco 1B, 1º
                        andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>
                <tr>
                    <th width="20%" scope="row">13h30 - 16h30</th>
                    <td width="50%">Workshop: User Experience (UX)<br>
                    <i>Ministrante: Rafael Siqueira (CEO e Foundador do Estúdio FLOW)</i>
                    </td>
                    <td width="30%">Laboratórios BSI-UFU (Bloco 1B, 1º
                        andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>
				<tr>
                    <th width="20%" scope="row">13h30 - 16h30</th>
                    <td width="50%">Workshop: Desafios e aplicações de Machine Learning no contexto de Ciências Agrárias<br>
					<i>Ministrantes: Pâmela Rezende (UFMG) e Joicymara Xavier (UFVJM)</i>
                    </td>
                    <td width="30%">Laboratórios BSI-UFU (Bloco 1B, 1º
                        andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>
                <tr>
                    ...
                    <td width="20%">Anfiteatro UNIFUCAMP</td>
                </tr>
                <tr>
                    <th scope="row">20h30 - 21h00</th>
                    <td width="50%">Premiações e Encerramento</td>
                    <td width="20%">Anfiteatro UNIFUCAMP</td>
                </tr>
            </tbody>
        </table>
