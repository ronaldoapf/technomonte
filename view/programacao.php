        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Palestra: "A perícia computacional na Polícia Federal" </td>
                    <td>Anfiteatro UNIFUCAMP</td>
                </tr>
            </tbody>
            ...
            <tbody>
                <tr>
                    ...
                    Ministrante: Pâmela Marinho Rezende</td>
                ...
                <tr>
                    <th width="20%"scope="row">09h00 - 12h00<br>13h30 - 16h30</th>
                    <td width="50%">Minicurso: Linux<br>Ministrante:</td>
                    <td width="30%">Laboratórios BSI (Bloco 1B, 1º andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>

                <tr>
                    <th width="20%"scope="row">09h00 - 12h00<br>13h30 - 16h30</th>
                    <td width="50%">Minicurso: React<br>Ministrante:</td>

                    <td width="30%">Laboratórios BSI (Bloco 1B, 1º andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>
                <tr>
                    <th width="20%"scope="row">09h00 - 12h00<br>13h30 - 16h30</th>
                    <td width="50%">Minicurso: Realidade Aumentada<br>Ministrante:</td>
                    <td width="30%">Laboratórios BSI (Bloco 1B, 1º andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>
            ...
            <tbody>
                <tr>
                    <th width="20%" scope="row">07h15 - 08h15</th>
                    <td width="50%">Aquecimento Maratona de Programação - Jovens Programadores</td>
                    <td width="30%">Laboratórios BSI-UFU (Bloco 1B, 1º
                        andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>
                <tr>
                    <th width="20%" scope="row">08h20 - 10h20</th>
                    <td width="50%">Maratona de Programação - Jovens Programadores</td>
                    <td width="30%">Laboratórios BSI-UFU (Bloco 1B, 1º
                        andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>

                <tr>
                    <th width="20%" scope="row">08h00 - 09h00</th>
                    <td width="50%">Aquecimento Maratona de Programação</td>
                    <td width="30%">Laboratórios BSI-UFU (Bloco 1B, 1º
                        andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>

                <tr>
                    <th width="20%" scope="row">09h00 - 12h00</th>
                    <td width="50%">Maratona de Programação</td>
                    <td width="30%">Laboratórios BSI-UFU (Bloco 1B, 1º
                        andar) Unidade Araras - UFU Monte Carmelo</td>
                </tr>
                <tr>
    ...
    <div class="patrocinadores">
        <div class="row">
            ...
            <div class="col-2 text-center">
                <img src="../assets/img/patrocinadores/posto_santarita.jpg" style="width: 90%;" alt="">
            </div>
            ...
            <div class="col-2 text-center">
                <img src="../assets/img/patrocinadores/ortodontic.png" style="width: 70%;" alt="">
            </div>
