        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <p style="text-align: justify;">
                        3.3. Um comitê julgador composto por docentes da UFU e UNIFUCAMP, indicados
                ...
                <br>
                <div class="col-12">
                    <h5><a target="_blank" href="../assets/mostra/editaltechnomonte2019.pdf">Edital em
                            PDF</a></h5>
                </div>

                <div class="col-12">
                    <h5>
                        <a target="_blank" href="../assets/mostra/modelo-poster-technomonte_2019.pptx">Modelo
                            do
                            pôster</a>
                    </h5>
                </div>
